...
public class FragmentImageAdapter extends BaseAdapter {
    ...
    public FragmentImageAdapter(Context context, List<Image> imageList, FragmentImageConfig imageConfig, CheckedCallback checkedCallback) {
        ...
        if (type == TYPE_CAMERA) {
            ...
            if (showSelectIndicator) {
                ...
                if (selectedImageList.contains(getItem(position))) {
                    holder.photo_check.setImageResource(R.drawable.icon_recommend_sel);
                    holder.photo_mask.setVisibility(View.VISIBLE);
                } else {
                    holder.photo_check.setImageResource(R.drawable.icon_recommend_unsel);
            ...
            holder.photo_check.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    checkedCallback.onChecked(getItem(position));
                }
            });
        }
    ...
    public void setSelectedImageList(List<Image> selectedImageList) {
