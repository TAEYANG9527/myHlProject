 ...
 */
public class CollectionRmqTextViewHolder extends RecyclerHolder {
    ...
    public CollectionRmqTextViewHolder(Context context, View itemView, RecyclerView collectionRecyclerView, RecyclerView.Adapter adapter) {
