 ...
 */
public class RemoveBlackListTask extends AsyncTask<String, Void, MessageBoardOperation> {
    private Context mContext;
    private AsyncTaskCallBack asyncTaskCallBack;

    public RemoveBlackListTask(Context mContext, AsyncTaskCallBack asyncTaskCallBack) {
    ...
    protected MessageBoardOperation doInBackground(String... params) {
        ...
        try {
            MessageBoardOperation mbo = (MessageBoardOperation) HttpUtil.doHttpRequest(Constants.Http.REMOVEBLACKLIST, reqParams,
