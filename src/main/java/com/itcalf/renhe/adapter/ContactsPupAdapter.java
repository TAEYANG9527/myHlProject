 ...
 */
public class ContactsPupAdapter extends BaseAdapter {
    private Context mContext;
    private List<PupBean> list;

    public ContactsPupAdapter(Context mContext) {
        list = Arrays.asList(
                new PupBean(mContext.getString(R.string.contact_dialogue_1), R.drawable.icon_contacts_connect),
