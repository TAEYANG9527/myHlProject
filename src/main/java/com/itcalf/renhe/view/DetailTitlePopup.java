 ...
 * @author
 */
public class DetailTitlePopup extends PopupWindow {
    ...
    public DetailTitlePopup(Context context) {
        this(context, LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT);
    }

    public DetailTitlePopup(Context context, int width, int height) {
        ...
        View view = LayoutInflater.from(mContext).inflate(R.layout.detail_comment_popu, null);
        setContentView(view);
        goodLl = (LinearLayout) view.findViewById(R.id.popu_good_ll);
        commentLl = (LinearLayout) view.findViewById(R.id.popu_comment_ll);
        shareLl = (LinearLayout) view.findViewById(R.id.popu_share_ll);
        good = (TextView) view.findViewById(R.id.popu_good);
        ...
        goodLl.setOnClickListener(onclick);
