...
//        Utils.hideTitleBar(this, R.id.imageselector_activity_layout, imageConfig.getSteepToolBarColor());
        ...
        getSupportFragmentManager().beginTransaction()
                .add(R.id.image_grid, Fragment.instantiate(this, FragmentImageSelectorFragment.class.getName(), null))
                .commit();
...
//                exit();
                ...
                imageList.add(image);
                Intent intent = new Intent(this, FragmentSelectPhotoActivity.class);
