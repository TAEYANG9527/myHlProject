...
public class ChatNormalArchiveViewHolder extends ChatViewHolder {
    ...
    public ChatNormalArchiveViewHolder(Context context, View itemView, RecyclerView chatRecyclerView,
    ...
    public void onContentRlClickListener() {
        String sid = linkedContentLink.substring(linkedContentLink.indexOf("//") + 2, linkedContentLink.length());
        Intent bundle = new Intent(context, MyHomeArchivesActivity.class);
        bundle.putExtra("profileSid", sid);
