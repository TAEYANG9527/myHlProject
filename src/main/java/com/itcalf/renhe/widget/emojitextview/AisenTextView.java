...
public class AisenTextView extends TextView {
    ...
    public int getEmojiSize() {
        if (null != BaseActivity.getRunningActivity())
            return BaseActivity.getRunningActivity().getResources().getDimensionPixelSize(R.dimen.rmq_emotion_size);
        else
            return RenheApplication.getInstance().getResources().getDimensionPixelSize(R.dimen.rmq_emotion_size);
    }
