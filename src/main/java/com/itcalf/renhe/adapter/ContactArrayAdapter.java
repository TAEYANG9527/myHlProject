 ...
 * @功能说明 联系人列表适配器带字母
 */
public class ContactArrayAdapter extends ArrayAdapter<ContactItem> implements PinnedSectionListAdapter {
    ...
    public ContactArrayAdapter(Context context, int resource, int textViewResourceId) {
