 ...
 * *****************************************************************************
 */
package com.itcalf.renhe.widget.photoview;
...
public interface IPhotoView {
     ...
     * single tap.
     *
     * @return HlPhotoViewAttacher.OnPhotoTapListener currently set, may be null
     */
    ...
    /**
     * Register a callback to be invoked when the Photo displayed by this View is rotated
     *
     ...
     *
     * @return HlPhotoViewAttacher.OnViewTapListener currently set, may be null
     */
    ...
    /**
     * Allows to change zoom transition speed, default value is 200 (HlPhotoViewAttacher.DEFAULT_ZOOM_DURATION).
    ...
    /**
     * Will return instance of HlIPhotoView (eg. HlPhotoViewAttacher), can be used to provide better
     * integration
     *
     * @return HlIPhotoView implementation instance if available, null if not
     */
     ...
     * default, you can just pass in "null" or public field of HlPhotoViewAttacher.defaultOnDoubleTapListener
     *
