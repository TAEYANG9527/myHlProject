 ...
 *
 * @author Alan
 * @deprecated 废弃自定义的RoundImageView，它会导致listview滑动卡顿，原因是imageloader应用自定义的imageview，
 * 无法做缓存，每次getview都会重新切图绘制，导致占用内存和cpu，目前修改成imageloader自带的displayer方式（自定义的circleImageDisplayer）实现圆图
 */
public class RoundImageView extends ImageView {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        } else if (mBorderInsideColor != defaultColor && mBorderOutsideColor == defaultColor) {// 定义画一个边�?
