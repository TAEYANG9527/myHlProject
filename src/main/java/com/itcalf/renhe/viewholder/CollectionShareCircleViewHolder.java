...
public class CollectionShareCircleViewHolder extends RecyclerHolder {
    ...
    public TextView forwardNoteTv;
    public RelativeLayout forwardRl;
    private ImageView forwardIv;
    public DateUtil dateUtil;

    public CollectionShareCircleViewHolder(Context context, View itemView, RecyclerView collectionRecyclerView, RecyclerView.Adapter adapter) {
        ...
        forwardIv = (ImageView) itemView.findViewById(R.id.forward_circle_pic_iv);
        ...
        forwardNameTv = (TextView) itemView.findViewById(R.id.forward_circle_name_tv);
        forwardNoteTv = (TextView) itemView.findViewById(R.id.forward_circle_desc_tv);
    ...
    public void initView(RecyclerHolder holder, Object mCollectionInfo, int position) {
        ...
        String shareNote = messageBoardShareInfo.getShareNote();//分享的圈子的描述
        String shareName = messageBoardShareInfo.getShareName();//分享的圈子的姓名
        ...
        forwardNoteTv.setVisibility(View.GONE);
