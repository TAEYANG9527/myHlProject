...
public class WebViewActivityForFindPwd extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setTextValue(R.id.title_txt, "忘记密码");
		//		webView.loadUrl("http://www.renhe.cn/forgot.html?from=heliao");
		webView.loadUrl(Constants.Http.FIND_PASSWORD);
	...
	protected void onResume() {
		super.onResume();
		MobclickAgent.onPageStart("找回密码"); //统计页面
	...
	protected void onPause() {
		super.onPause();
		MobclickAgent.onPageEnd("找回密码"); // 保证 onPageEnd 在onPause 之前调用,因为 onPause 中会保存信息 
