...
public class OCRItems implements Serializable {
	...
	public String[] getItemValue(int id) {
		...
		case ID_OTHER:
			return other;
		default:
			log.info("invalid id " + id + ", is too small or too large");
			throw new IllegalArgumentException("invalid id " + id + ", is too small or too large");
		}
	}
	 ...
	 * @return
	 */
	public JSONArray getJSONArrayByStringArray(String[] stringArray) {
	...
	public String returnJSONData() {
		...
		try {
			returnData.put("familyName", getJSONArrayByStringArray(familyName));
			returnData.put("familyKana", getJSONArrayByStringArray(familyKana));
			returnData.put("givenName", getJSONArrayByStringArray(givenName));
			returnData.put("name", getJSONArrayByStringArray(name));
			returnData.put("telephone", getJSONArrayByStringArray(telephone));
			returnData.put("cellphone", getJSONArrayByStringArray(cellphone));
			returnData.put("phs", getJSONArrayByStringArray(phs));
			returnData.put("email", getJSONArrayByStringArray(email));
			returnData.put("organization", getJSONArrayByStringArray(organization));
			returnData.put("department", getJSONArrayByStringArray(department));
			returnData.put("title", getJSONArrayByStringArray(title));
			returnData.put("postcode", getJSONArrayByStringArray(postcode));
			returnData.put("address", getJSONArrayByStringArray(address));
			returnData.put("adrRegion", getJSONArrayByStringArray(adrRegion));
			returnData.put("adrLocality", getJSONArrayByStringArray(adrLocality));
			returnData.put("adrStreet", getJSONArrayByStringArray(adrStreet));
			returnData.put("adrInfo", getJSONArrayByStringArray(adrInfo));
			returnData.put("url", getJSONArrayByStringArray(url));
			returnData.put("fax", getJSONArrayByStringArray(fax));
			returnData.put("other", getJSONArrayByStringArray(other));
