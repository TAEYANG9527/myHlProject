...
public class AdLogoClipView extends View {
    ...
    public static final float heightScale = 0.6f;//高度是宽度的0.6倍
    public AdLogoClipView(Context context) {
        this(context, null);
        this.mContext = context;
    }

    public AdLogoClipView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
        this.mContext = context;
    }

    public AdLogoClipView(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        Float hf = (float) mFocusWidth * heightScale;
