 ...
 */
public class CollectionShareWebViewHolder extends RecyclerHolder {
    ...
    public CollectionShareWebViewHolder(Context context, View itemView, RecyclerView collectionRecyclerView, RecyclerView.Adapter adapter) {
    ...
    public void initView(RecyclerHolder holder, Object mCollectionInfo, int position) {
        ...
        String shareContent = messageBoardShareInfo.getShareContent();//分享的网页的网页文字内容
        ...
        if (!TextUtils.isEmpty(shareContent))
            forwardContentTv.setText(shareContent);
        else
        ...
        if (!TextUtils.isEmpty(imageUrl)) {
            imageLoader.displayImage(imageUrl, forwardIv,
                    CacheManager.imWebImageOptions);
        }
        initListener();
    }
