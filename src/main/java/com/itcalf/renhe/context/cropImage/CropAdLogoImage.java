...
public class CropAdLogoImage extends BaseActivity {
    ...
    private ClipAdLogoImageView mCropImage;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTextValue(0, "裁剪图片");
        mCropImage = (ClipAdLogoImageView) findViewById(R.id.src_pic);
...
//            bitmap = BitmapUtil.getBitmap(imagePath, ClipView.IMAGE_WIDTH * 2, ClipView.IMAGE_WIDTH * 2);
        ...
        saveBt.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                FileUtil.writeImage(bitmap, FileUtil.SDCARD_PAHT + "/croplogo.png", 100);
                Intent mIntent = new Intent();
                mIntent.putExtra("cropImagePath", FileUtil.SDCARD_PAHT + "/croplogo.png");
