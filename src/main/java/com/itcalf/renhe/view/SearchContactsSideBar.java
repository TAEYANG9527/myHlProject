...
public class SearchContactsSideBar extends View {
	// 触摸事件
	...
	public SearchContactsSideBar(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
	}

	public SearchContactsSideBar(Context context, AttributeSet attrs) {
		super(context, attrs);
	}

	public SearchContactsSideBar(Context context) {
		super(context);
	}
